...
CSV.open("saadi_report.csv", 'w') do |csv|
  csv << ["Enrollment Group ID", "Status", "Authority", "Policy ID", "Sponsor", "Premium Total", "Contribution/APTC", "Total Responsible", "Coverage Type", "Plan HIOS ID", "Plan Name", "Carrier Name", "HBX Id", "Subscriber", "First", "Middle", "Last", "DOB", "SSN", "Start", "End"]
