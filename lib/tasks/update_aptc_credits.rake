require File.join(Rails.root,"app","data_migrations","update_aptc_credits.rb")
  ...
  # format RAILS_ENV=production bundle exec rake migrations:update_aptc_credits eg_id="123" tot_res_amt="23.5" pre_amt_tot="12.3" aptc="23" start_on="4/2/2018" end_on="6/2/2018"
