...
# format RAILS_ENV=production bundle exec rake migrations:merge_duplicate_people person_to_keep='person_mongo_id' persons_to_remove='person_mongo_id,person_mongo_id'
