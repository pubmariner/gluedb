...
#  define_multi_worker(app, "edi_ops_listener", "script/amqp/edi_ops_listener.rb", BUS_DIRECTORY, 1)
  define_multi_worker(app, "enrollment_creator", "script/amqp/enrollment_creator.rb", BUS_DIRECTORY, 2)
  define_multi_worker(app, "enrollment_validator", "script/amqp/enrollment_validator.rb", BUS_DIRECTORY, 2)
  define_multi_worker(app, "person_matcher", "script/amqp/person_matcher.rb", BUS_DIRECTORY, 10)
end
